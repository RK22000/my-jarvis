#!/usr/bin/env python3
"""
Vosk server code pulled from git hub repo as is at 
https://raw.githubusercontent.com/alphacep/vosk-server/master/websocket-microphone/asr_server_microphone.py
